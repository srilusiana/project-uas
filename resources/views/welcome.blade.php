            ...
            <div class="carousel-car owl-carousel">
                ...
                <div class="car-wrap rounded ftco-animate">
                    ...
                    <div class="d-flex mb-3">
                        <span class="subheading">Internal Combustion</span>
                        <p class="price ml-auto">Rp.200.000</p>
                    </div>
                    <p class="d-flex mb-0 d-block"><a href="#" class="btn btn-primary py-2 mr-1">buy this product</a> <a href="#"
                ...
                <div class="car-wrap rounded ftco-animate">
                    ...
                    <div class="d-flex mb-3">
                        <span class="cat">External Combustion</span>
                ...
                <div class="item">
                <div class="car-wrap rounded ftco-animate">
                    <div class="img rounded d-flex align-items-end" style="background-image: url('{{ asset('admin/dist/img/Paket_d.jpeg') }}');">
                    </div>
                    <div class="text">
                    <h2 class="mb-0"><a href="#">Paket D</a></h2>
                    <div class="d-flex mb-3">
                        <span class="cat">V-Engine BMW</span>
                        <p class="price ml-auto">Rp.950.000</p>
                    </div>
                    <p class="d-flex mb-0 d-block"><a href="#" class="btn btn-primary py-2 mr-1">Book now</a> <a href="#"
                        class="btn btn-secondary py-2 ml-1">Details</a></p>
                    </div>
    ...
    <section class="ftco-section ftco-about">
        ...
        <div class="row no-gutters">
            ...
            <div class="heading-section heading-section-white pl-md-5">
                ...
                <p>Tentu! Berikut adalah contoh kalimat tentang layanan mobil dan ucapan selamat datang:
